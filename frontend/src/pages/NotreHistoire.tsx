    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-6 py-14">
        ...
        <header className="mb-14 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-[#0B2270]/70">
              ...
              {timeline.map((etape, i) => {
                ...
                return (
                  <li key={`${etape.titre}-${i}`} className="relative">
                    ...
                    <p className="mt-1.5 text-sm leading-relaxed text-[#0B2270]/70">
                      {etape.description}
                    </p>
                  </li>
                );
        ...
        <section className="mb-16">
          ...
          <p className="mb-6 text-sm leading-relaxed text-[#0B2270]/70">
            {notreHistoireJSON.textePartie2}
          </p>

          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-club-100 bg-white p-5">
              <span className="flex items-center gap-1.5 text-xs font-medium text-[#0B2270]/50">
                <MapPin size={12} />
              ...
              <p className="mt-1.5 text-sm text-[#0B2270]/70">
        ...
        <section className="rounded-2xl border border-club-100 bg-club-50/60 p-7 sm:p-8">
          ...
          <p className="mb-4 text-sm leading-relaxed text-[#0B2270]/70">
            {notreHistoireJSON.paragraphe1Partie3}
          </p>

          <div className="flex items-start gap-2 text-sm text-[#0B2270]/70">
