        ...
        <>
            ...
            <div className="mx-auto max-w-6xl w-full px-4 sm:px-6 py-6 sm:py-12">
                ...
                {articles == null ? (
                    ...
                    <div className="flex flex-col items-center justify-center gap-2 rounded-xl h-[342px] border border-dashed border-club-200 px-4 py-16 sm:py-20 text-center">
                        <Inbox size={28} className="text-[#0B2270]/40" />
                        <p className="text-sm font-medium text-[#0B2270]/85">
